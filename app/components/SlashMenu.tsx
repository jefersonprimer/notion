...
export const MENU_ITEMS = [
  ...
  { id: 'todo', label: 'Lista de tarefas', icon: <ListTodo size={18} /> },
  { id: 'toggle', label: 'Lista de alternantes', icon: <ListCollapse size={18} /> },
...
export function SlashMenu({ leftOffset, position, onSelect, onClose }: SlashMenuProps) {
  ...
  return (
    <div
      ...
      className={`absolute z-60 w-60 bg-white dark:bg-[#252525] border border-gray-200 dark:border-[#3f3f3f] rounded-lg shadow-xl overflow-y-auto py-2 animate-in fade-in zoom-in-95 duration-100 outline-none ${position ? '' : (leftOffset === undefined ? 'left-0 ' : '')
      ...
      {MENU_ITEMS.map((item, index) => (
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm text-gray-700 dark:text-[#e6e5e3]">{item.label}</span>
